...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full h-16 flex justify-center px-4 md:px-8 xl:px-16 bg-background z-[100]">
      <div className="w-full h-full flex gap-8 xl:gap-16 items-center justify-between">
        ...
        <div className="flex-1 flex justify-start gap-4 md:gap-8 xl:gap-16">
            ...
            return (
              ...
              >
                <p
                  ...
                  onMouseEnter={() => handleMouseEnter(routes.name, i)}
                  className="no-select"
                >
                  {routes.name}
                </p>
